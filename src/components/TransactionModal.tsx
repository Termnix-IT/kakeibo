      ...
      <div className="space-y-4">
              ...
              <button
                ...
                className={`py-2.5 text-sm font-semibold transition-colors ${
                  active
                    ...
                    : 'bg-[var(--color-surface-2)] text-neutral-600 hover:bg-[var(--color-primary-subtle)]'
                }`}
              >
                {t === 'expense' ? '支出' : '収入'}
              </button>
        ...
        <div
          className={`rounded-md border px-4 py-5 ${
            isExpense
              ? 'bg-expense-subtle border-[rgba(180,88,56,0.45)]'
              : 'bg-income-subtle border-[var(--color-primary-border)]'
          }`}
        >
                ...
                <button
                  ...
                  className={`inline-flex items-center gap-1.5 rounded-full border px-3 py-1.5 text-xs font-medium transition-colors ${
                    selected
                      ...
                      : 'border-[var(--color-surface-border-strong)] bg-[var(--color-surface-2)] text-neutral-700 hover:border-[var(--color-primary-border)]'
                  }`}
                  style={
                    selected
